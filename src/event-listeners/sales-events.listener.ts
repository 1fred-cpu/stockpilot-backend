...
export class SalesEventsListener {
  ...
  private async handleSaleCreatedEvent(data: any) {
    ...
    if (sale.customer_email) {
      ...
      <ul>
        ...
        <li><strong>Date:</strong> ${new Date(receipt.created_at).toLocaleString()}</li>
      </ul>
      <p>You can <a href="${pdfUrl}" target="_blank">download your receipt PDF here</a>.</p>
      <br />
      <p>If you have any questions, feel free to contact us at ${business.email || 'support@example.com'}.</p>
    `;
